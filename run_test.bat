...
rem    3) 自动运行全部 5 组测试：冒烟 / 33 用例套件 / HTTP 13 项 / 官方 SDK stdio / HTTP
rem    4) 汇总报告
rem
...
rem ---- 测试 2：全面测试套件（33 用例，需 mcp 包，首次自动下载）----
echo.
echo ----- [2/5] 全面测试套件（33 用例：握手/工具/提示词/资源/安全/裸协议）-----
...
rem ---- 测试 3：HTTP 传输层专项（13 项）----
echo.
echo ----- [3/5] HTTP 传输层专项（13 项）-----
